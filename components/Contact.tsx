    ...
    <section id="contact" className="bg-gray-100 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-xl text-gray-600">نحن هنا للإجابة على استفساراتك وتقديم المساعدة</p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                <Phone className="h-6 w-6 text-blue-500 ml-4" />
                <span className="text-lg text-gray-700">+966 123 456 789</span>
              </div>
              <div className="flex items-center">
                <Mail className="h-6 w-6 text-blue-500 ml-4" />
                <span className="text-lg text-gray-700">info@blueskymovers.sa</span>
              </div>
              <div className="flex items-center">
                <MapPin className="h-6 w-6 text-blue-500 ml-4" />
                <span className="text-lg text-gray-700">شارع الملك فهد، الرياض، المملكة العربية السعودية</span>
              </div>
            </div>
          </div>
          <div>
